...
let getCont=document.querySelector(".section-center")
let getButtons=document.querySelector('.btn-container')
...
buttons.forEach(item=>{
  ...
  return getButtons.appendChild(btn)
})
